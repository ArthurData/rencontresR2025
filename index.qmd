...
::: {.fragment .fade-left}
- Valider progressivement avec son client, les étapes de développement
...
::: {.fragment .fade-left}
Mais Pierrot est développeur R, il va donc utiliser le nouveau package R : <span class="relevant">[`{pw}`](https://github.com/ThinkR-open/pw)</span>
:::
:::
::::
...
<a href="https://connect.thinkr.fr/signature-r/" target="_blank">🔗 `{signature.r}`</a>
:::
::::
